...
// DEF3264: CSecondaryTaskBand::CSecondaryTaskBand
LONG_PTR EV_SECONDARY_TASK_BAND_MM_TASKLIST_OFFSET()
{
	return DO17_3264(0x14, 0x28, ,, ,, ,, ,, ,,
		// WIN_VERSION_10_R1 (1607)
		nExplorerQFE <= 7513 ? 0x14 : 0x24, nExplorerQFE <= 7513 ? 0x28 : 0x40,
		// WIN_VERSION_10_R2
		0x14, 0x28,
		// WIN_VERSION_10_R3
		,,
		...
		nExplorerQFE <= 7309 ? 0x14 : 0x24, nExplorerQFE <= 7309 ? 0x28 : 0x40,
		// WIN_VERSION_10_19H1
		0x14, 0x28,
		// WIN_VERSION_10_20H1 (2004, 20H2, 21H1, 21H2, 22H2)
		nExplorerQFE <= 6575 ? 0x14 : 0x24, nExplorerQFE <= 6575 ? 0x28 : 0x40,
		// WIN_VERSION_SERVER_2022
		nExplorerQFE <= 3692 ? 0x28 : 0x40,
		// WIN_VERSION_11_21H2
		0x28,
		// WIN_VERSION_11_22H2
		nExplorerQFE <= 6274 ? 0x28 : 0x40,
		// WIN_VERSION_NEXT
		0x40);
}
...
{
	return (DWORD *)(lp + EV_SECONDARY_TASK_BAND_MM_TASKLIST_OFFSET() + DEF3264(0x0C, 0x18));
}

LONG_PTR *EV_SECONDARY_TASK_BAND_SECONDARY_TASKBAR_REF(LONG_PTR lp)
{
	return (LONG_PTR *)(lp + EV_SECONDARY_TASK_BAND_MM_TASKLIST_OFFSET() + DEF3264(0x14, 0x28));
}
...
{
	return *EV_MM_TASKLIST_TASK_BAND_REF(lp) - EV_SECONDARY_TASK_BAND_MM_TASKLIST_OFFSET();
}
